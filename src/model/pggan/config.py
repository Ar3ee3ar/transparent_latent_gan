...
desc += '-preset-v2-1gpu'; num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 128, 8: 128, 16: 128, 32: 64, 64: 32, 128: 16}; sched.G_lrate_dict = {128: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 12000
...
desc += '-fp32'; sched.max_minibatch_per_gpu = {32: 16, 64: 8, 128: 4}
